...
import { ArrowRight, Settings, Construction, Layers, Wrench } from 'lucide-react';
...
const productCategories = [
  {
    ...
    description: 'High-quality excavator attachments for enhanced productivity and performance.',
    subcategories: [
      {
        id: 'extended-arm',
        name: 'Extended Arm',
  ...
  },
  {
    ...
    description: 'Durable ground engaging tools designed for maximum efficiency and longevity.',
    subcategories: [
      {
  ...
  },
  {
    ...
    description: 'Complete range of undercarriage components for optimal machine mobility.',
    subcategories: [
      {
        id: 'track-roller',
        name: 'Track Roller',
  ...
  },
  {
    ...
    description: 'High-grade rubber components for reduced noise and improved traction.',
    subcategories: [
      {
        id: 'rubber-track',
        name: 'Rubber Track',
  ...
  },
  {
    ...
    description: 'Custom solutions and specialized components for unique requirements.',
    subcategories: [
      {
        id: 'custom-orders',
        name: 'Custom Orders',
...
<div className="relative bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white py-24 px-6 md:px-20 overflow-hidden">
  ...
  <div className="relative z-10 max-w-5xl mx-auto text-center">
    ...
    <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
      Explore excavator attachments, undercarriage parts, and custom components — all engineered to push limits and power productivity.
    </p>
